...
public class godwin_sun_Messages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<1;i++)
        {
            Thread thread = new Thread(new Runnable() {
                @Override
                public void run() {
                    String address2 = "http://www.seattlechristianassembly.org/godwinsun_msgs.html";
                    try
                    {
                        Document docs = null;
                        try
                        ...
                        String div;
                        URL pageLocation = new URL("http://www.seattlechristianassembly.org/godwinsun_msgs.html");
        ...
        try
        {
            ...
            Titles.add("1");
            MessageAdapter adapter  = new MessageAdapter(this,getMessage(),ActualURLList,Titles,3);
